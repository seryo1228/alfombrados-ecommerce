          ...
          >
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                {selectedItem.status === "disponible" ? (
                  <Button asChild className="flex-1 text-white border-0" style={{ backgroundColor: "#25D366" }} onMouseEnter={e => (e.currentTarget as HTMLButtonElement).style.backgroundColor = "#1ebe5d"} onMouseLeave={e => (e.currentTarget as HTMLButtonElement).style.backgroundColor = "#25D366"}>
                    <a
      ...
      <section className="bg-primary/5 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" asChild className="text-white border-0" style={{ backgroundColor: "#25D366" }} onMouseEnter={e => (e.currentTarget as HTMLButtonElement).style.backgroundColor = "#1ebe5d"} onMouseLeave={e => (e.currentTarget as HTMLButtonElement).style.backgroundColor = "#25D366"}>
              <a
